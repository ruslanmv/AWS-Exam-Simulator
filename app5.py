...
def show_explanation(index):
    ...
    if 0 <= index < len(selected_questions):
        ...
        return (
            ...
            gr.update(visible=False)  # Hide result_text # Hide result text when explaination is shown
        )
    else:
...
def finish_exam(temp_report_path):
    ...
    # report_json_content, home_button_visible = display_report(report_json) # Call display_report and get JSON content # OLD JSON DISPLAY
