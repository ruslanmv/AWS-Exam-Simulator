...
import time
from utils3 import display_report
import json
import tempfile
...
def finish_exam(temp_report_path):
    ...
    report_html, home_button_visible = display_report(report_json) # Call display_report and get HTML with JSON string
    ...
    return (
        ...
        gr.update(visible=False),  # explanation_text
        report_html,  # Return the HTML report
        temp_report_path,
...
with gr.Blocks(css="style.css", title="Exam Simulator") as demo:
    ...
    report_display = gr.HTML(visible=False, elem_classes="report-display") # Added HTML display for report
